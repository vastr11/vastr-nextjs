...
export const metadata: Metadata = {
    title: 'Pocket Square | VASTR – Premium Men\'s Accessories',
    description: 'Shop premium pocket squares at VASTR. Silk and cotton pocket squares for weddings and formal occasions.',
};

const products = [
    { id: 1, name: 'White Silk Pocket Square', price: 800, badge: 'NEW IN', isDark: false },
    { id: 2, name: 'Navy Pocket Square', price: 900, badge: '', isDark: true },
    { id: 3, name: 'Burgundy Silk Square', price: 1000, badge: 'PREMIUM', isDark: false },
    { id: 4, name: 'Gold Paisley Square', price: 1200, badge: 'PREMIUM', isDark: true },
    { id: 5, name: 'Black Pocket Square', price: 700, badge: '', isDark: false },
    { id: 6, name: 'Cream Linen Square', price: 600, badge: 'SALE', isDark: true },
    { id: 7, name: 'Floral Print Square', price: 850, badge: 'NEW IN', isDark: false },
    { id: 8, name: 'Embroidered Square', price: 1500, badge: 'SALE', isDark: true },
];

export default function PocketSquarePage() {
    return (
        <>
            <Header />
            <main>
                <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '20px 32px 0' }}>
                    <ol style={{ display: 'flex', gap: '8px', listStyle: 'none', fontFamily: 'Cormorant Garamond, serif', fontSize: '12px', color: '#8a8a8a' }}>
                        ...
                        <li>·</li>
                        <li style={{ color: '#1a1a1a' }}>Pocket Square</li>
                    </ol>
                </div>
                ...
                <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '32px 32px 0' }}>
                    ...
                    <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '15px', color: '#8a8a8a', marginBottom: '32px' }}>
                        Silk and cotton pocket squares for every occasion
                    </p>
                </div>
                ...
                <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 32px 80px' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '24px 16px' }}>
                        {products.map((product) => (
                            <Link key={product.id} href={`/product/pocket-square-${product.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
